...
class GoogleVrProxy extends b implements GoogleVrVideo {
    ...
    private boolean a(ClassLoader classLoader) {
        try {
            ...
            nVar.a("initialize", new Class[]{Activity.class, Context.class, SurfaceView.class, Boolean.TYPE, Handler.class});
            nVar.a("deinitialize", new Class[0]);
            nVar.a("load", new Class[]{Boolean.TYPE, Boolean.TYPE, Boolean.TYPE, Boolean.TYPE, Boolean.TYPE, Runnable.class});
            nVar.a("enable", new Class[]{Boolean.TYPE});
            nVar.a("unload", new Class[0]);
            nVar.a("pause", new Class[0]);
            nVar.a("resume", new Class[0]);
            nVar.a("getGvrLayout", new Class[0]);
            nVar.a("getVideoSurfaceId", new Class[0]);
            nVar.a("getVideoSurface", new Class[0]);
            this.f139a = nVar;
            return true;
        } catch (Exception e) {
    ...
    public final boolean a(Activity activity, Context context, SurfaceView surfaceView, Runnable runnable) {
        ...
        if (activity == null || context == null || surfaceView == null || runnable == null) {
            ...
            if (!a(19)) {
                ...
                try {
                    z = ((Boolean) this.f139a.a("initialize", activity, context, surfaceView, Boolean.valueOf(this.g), this.m)).booleanValue();
                } catch (Exception e) {
    ...
    public Object getVideoSurface() {
        if (d() && !this.k.e) {
            try {
                return this.f139a.a("getVideoSurface", new Object[0]);
            } catch (Exception e) {
    ...
    public int getVideoSurfaceId() {
        if (d() && !this.k.e) {
            try {
                return ((Integer) this.f139a.a("getVideoSurfaceId", new Object[0])).intValue();
            } catch (Exception e) {
    ...
    public long loadGoogleVr(boolean z, boolean z2, boolean z3, boolean z4, boolean z5) {
        ...
        if (!runOnUiThreadWithSync(new Runnable() {
            public final void run() {
                try {
                    atomicLong2.set(((Long) GoogleVrProxy.this.f139a.a("load", Boolean.valueOf(z6), Boolean.valueOf(z7), Boolean.valueOf(z8), Boolean.valueOf(z9), Boolean.valueOf(z10), GoogleVrProxy.this.h)).longValue());
                    GoogleVrProxy.this.k.f65b = true;
                } catch (Exception e2) {
    ...
    public void pauseGvrLayout() {
        if (this.k.a() && !this.k.e) {
            ...
            if (this.f139a != null) {
                this.f139a.a("pause", new Object[0]);
            }
            this.k.e = true;
        }
    }
    ...
    public void resumeGvrLayout() {
        if (this.k.a() && this.k.e) {
            if (this.f139a != null) {
                this.f139a.a("resume", new Object[0]);
            }
            this.k.e = false;
        }
    }
    ...
    public void setGoogleVrModeEnabled(final boolean z) {
        if (this.k.a() && this.f140b != null && this.c != null) {
            if (!z && isQuiting()) {
                e();
            }
                        ...
                        try {
                            if (z) {
                                if (!GoogleVrProxy.this.d()) {
                                    if (GoogleVrProxy.this.f139a == null || GoogleVrProxy.this.f140b == null || GoogleVrProxy.this.f140b.addViewToPlayer((View) GoogleVrProxy.this.f139a.a("getGvrLayout", new Object[0]), true)) {
                                        if (GoogleVrProxy.this.f139a != null) {
                                            GoogleVrProxy.this.f139a.a("enable", true);
                                        }
                            ...
                            if (!z && GoogleVrProxy.this.d()) {
                                ...
                                if (GoogleVrProxy.this.f139a != null) {
                                    GoogleVrProxy.this.f139a.a("enable", false);
                                }
                                if (GoogleVrProxy.this.f139a != null && GoogleVrProxy.this.f140b != null) {
                                    GoogleVrProxy.this.f140b.removeViewFromPlayer((View) GoogleVrProxy.this.f139a.a("getGvrLayout", new Object[0]));
                                }
                            }
                        } catch (Exception e) {
                            GoogleVrProxy googleVrProxy = GoogleVrProxy.this;
    ...
    public void unloadGoogleVr() {
        ...
        runOnUiThread(new Runnable() {
            public final void run() {
                try {
                    if (GoogleVrProxy.this.f139a != null) {
                        GoogleVrProxy.this.f139a.a("unload", new Object[0]);
                        GoogleVrProxy.this.f139a.a("deinitialize", new Object[0]);
                        GoogleVrProxy.this.f139a = null;
                    }
                    GoogleVrProxy.this.k.f65b = false;
                } catch (Exception e) {
                    GoogleVrProxy googleVrProxy = GoogleVrProxy.this;
