...
public class ImageMetadata {
    ...
    private void getMetdataEntry(int i, o oVar) {
        ...
        oVar.f29a = nativeGetMetadataEntry;
        if (nativeGetMetadataEntry != 0) {
            oVar.f30b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, nativeGetMetadataEntry);
            oVar.c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, oVar.f29a);
            return;
        }
    ...
    public byte getByte(int i) throws MetadataNotFoundException {
        ...
        if (oVar.f30b == 0 && oVar.c == 1) {
            byte nativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f29a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f29a);
    ...
    public byte[] getByteArray(int i) throws MetadataNotFoundException {
        ...
        o oVar = this.sketchEntry;
        if (oVar.f30b == 0) {
            byte[] nativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f29a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f29a);
    ...
    public double getDouble(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        o oVar = this.sketchEntry;
        if (oVar.f30b == 4 && oVar.c == 1) {
            double nativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f29a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f29a);
    ...
    public double[] getDoubleArray(int i) throws MetadataNotFoundException {
        ...
        o oVar = this.sketchEntry;
        if (oVar.f30b == 4) {
            double[] nativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f29a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f29a);
    ...
    public float getFloat(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        o oVar = this.sketchEntry;
        if (oVar.f30b == 2 && oVar.c == 1) {
            float nativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f29a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f29a);
    ...
    public float[] getFloatArray(int i) throws MetadataNotFoundException {
        ...
        o oVar = this.sketchEntry;
        if (oVar.f30b == 2) {
            float[] nativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f29a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f29a);
    ...
    public int getInt(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        o oVar = this.sketchEntry;
        if (oVar.f30b == 1 && oVar.c == 1) {
            int nativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f29a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f29a);
    ...
    public int[] getIntArray(int i) throws MetadataNotFoundException {
        ...
        o oVar = this.sketchEntry;
        if (oVar.f30b == 1) {
            int[] nativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f29a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f29a);
    ...
    public long getLong(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        o oVar = this.sketchEntry;
        if (oVar.f30b == 3 && oVar.c == 1) {
            long nativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f29a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f29a);
            return nativeGetLongFromMetadataEntry;
        }
        throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d, type: %2$d, count: %3$d.", new Object[]{Integer.valueOf(i), Integer.valueOf(this.sketchEntry.f30b), Integer.valueOf(this.sketchEntry.c)}));
    }
    ...
    public long[] getLongArray(int i) throws MetadataNotFoundException {
        ...
        o oVar = this.sketchEntry;
        if (oVar.f30b == 3) {
            long[] nativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f29a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f29a);
    ...
    public Rational getRational(int i) throws MetadataNotFoundException {
        getMetdataEntry(i, this.sketchEntry);
        o oVar = this.sketchEntry;
        if (oVar.f30b == 5 && oVar.c == 1) {
            Rational nativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f29a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f29a);
    ...
    public Rational[] getRationalArray(int i) throws MetadataNotFoundException {
        ...
        o oVar = this.sketchEntry;
        if (oVar.f30b == 5) {
            Rational[] nativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, oVar.f29a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f29a);
